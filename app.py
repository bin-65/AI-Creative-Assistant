...
def call_groq_ai(prompt_text):
    ...
    if not api_key:
        raise Exception("Streamlit Secrets mein 'GROQ_API_KEY' missing hai.")
    ...
    raise Exception("Groq API Call failed. Please check API Key.")
        ...
        if not input_text.strip():
            ...
            try:
                ...
                with st.spinner("Translating..."):
                    res_text = call_groq_ai(translation_prompt)
        ...
        if not user_prompt.strip() and not uploaded_files:
            ...
            try:
                with st.spinner("Processing requested output..."):
                    ...
                    res_text = call_groq_ai(final_instruction)
            ...
            if not doc_topic.strip():
                ...
                try:
                    with st.spinner("Building document..."):
                        ...
                        generated_text = call_groq_ai(gen_prompt)
            ...
            if not uploaded_docs:
                ...
                try:
                    with st.spinner("Extracting content..."):
                        ...
                        output_text = call_groq_ai(mcq_prompt)
